...
namespace fg {
    namespace gc {
        ...
        ScaleInterpCrossSec::ScaleInterpCrossSec( const Interpolator<Vec3> &interp, const Interpolator<double> &scale )
        ...
        {
			int n = -1;
			Interpolator<Vec3> * it = mInterpolator.scale( mScale.getPosition( v ) );
			Interpolator<Vec3> * it2 = it->scale( scale );
