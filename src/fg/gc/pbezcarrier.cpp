    ...
    namespace gc {
        ...
        PBezCarrier &PBezCarrier::operator=( const PBezCarrier &other )
        {
            if( other.mInterpolator == NULL )
                ...
                this->mInterpolator = new PBezInterpDiv( *( other.mInterpolator ) );
        ...
        void PBezCarrier::setReferenceFrames( const std::vector<Mat4> &refFrames, const std::vector< std::pair<double, double> > &stiffness )
        {
            ...
            mInterpolator = new PBezInterpDiv( tmpCp, tmpGrad );
            // Store our data
            mRFrames = refFrames;
        ...
        const PBezInterpDiv * PBezCarrier::getInterpolator() const
        {
        ...
        Quat PBezCarrier::orient( double v ) const
        {
            ...
            /*
                ...
                case 0: // No inflection
                    break;
                case 1: // One inflection
                    if (Interpoloator<double>::AlmostEqual2sComplement( localV, inflectionPoints[seg].first, 10000 )) {
