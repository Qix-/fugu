/**
 * \file
 * \brief syntax highlighting for fugu scripts
 * \author ben
  *
 * \cond showlicense
 * \verbatim
...
//! lexer.
class /*QSCINTILLA_EXPORT*/ FGLexer : public QsciLexer
{
    Q_OBJECT
...
public:
     ...
     * @param fuguKeywords
     */
    inline void registerFuguKeywords(const char* fuguKeywords){mFuguKeywords = fuguKeywords;}
...
private:
    ...
    bool fold_compact;
    QFont mFont, mBoldFont;
    const char* mFuguKeywords;

    FGLexer(const FGLexer &);
    FGLexer &operator=(const FGLexer &);
};
