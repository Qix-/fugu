...
function setup()
    ...
    --
		--local a = array_concat({1},{2,4,5})
		--print(type(a),#a)
		
		-- add_slider {var="LENGTH_SCALE", value=LENGTH_SCALE, low=0.8, high=2}
		
    axiom = '^(-pi/2) G#(1) (Gsc(1.),0) Gs G#(0) (A(1,.3,STEM_SEGS,.1),0) Ge(4)'
    rules = {
				'(A(l,w,n,b),1) : n > 0  -> (S(l,b,w),0)(A(l,w*.9,n-1,b-.02),0)',
				'(A(l,w,n,b),1) : n == 0 -> (B(INTER_THING_LENGTH*l,w,NUM_THINGS,.0),0)',
				'(B(l,w,n,b),1) : n > 0  -> [ \\(PHI * n) (Gsc(w*.7),0) Gs (C(l*LENGTH_OF_THINGY,w*.5,9,.1),0) Ge(4) ] (S(l,b,w),0) (B(l*LENGTH_SCALE,w*.95,n-1,b),0)', 
				'(C(l,w,n,b),1) : n > 0  -> (S(l,b,w),0) (C(l,w*.99,n-1,b-.028),0)',
				-- '(C(l,w,n,b),1) : n == 0 -> ',
				'(C(l,w,n,b),1) : n == 0 -> (S(1.*l,0.,.9*l),0) (S(1.*l,0.,.36*l),0) (S(.55*l,0.,.37*l),0) (S(.2*l,0.,.46*l),0) (f(.15*l),0) (Gsc(.36*l),0)',
