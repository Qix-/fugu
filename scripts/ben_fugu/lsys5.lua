...
function setup()
	...
	--[[
	axiom = '^(-pi/2) G#(1) (Gsc(.5),0) Gs G#(0) (A(.3,.2,STEM_SEGS,TRUNK_CURVE),0) Ge(4)'
	rules = {
			'(A(l,w,n,b),1) : n > 0  -> (S(l,b,w),0)(A(l,w*.9,n-1,b-.02),0)',
			'(A(l,w,n,b),1) : n == 0 -> (B(INTER_THING_LENGTH,.15,NUM_THINGS,.0),0)',
			
			'(B(l,w,n,b),1) : n > 0  -> [ \\(PHI * n) (Gsc(w*.9),0) Gs (C((.01/l)*LENGTH_OF_THINGY*random(.9,1.5),w*.8,9,.1),0) Ge(4) ] (S(l,b,w),0) (B(l*LENGTH_SCALE,w*1.01,n-1,b),0)', 
			...
			'(C(l,w,n,b),1) : n == 0 -> (S(.5*l,.5*TURN_OUTWARD,.9*l),0) (S(.5*l,.5*TURN_OUTWARD,.75*l),0) (S(.55*l,TURN_OUTWARD,.6*l),0) (S(.55*l,TURN_OUTWARD,.6*l),0) (S(.8*l,0,.5*l),0) (S(.5*l,0,.46*l),0) (f(.25*l),0) (Gsc(.6*l),0)',
	...
	rules = {
			...
			'(B(l,w,n,b),1) : n > 0  -> [ \\(PHI * n) (Gsc(w*.9),0) Gs (C((.02/l)*LENGTH_OF_THINGY*random(.9,1.5),w*.8,9,.1),0) Ge(4) ] (S(l,b,w),0) (B(l*LENGTH_SCALE,w*.98,n-1,b),0)', 
			
			'(C(l,w,n,b),1) : n > 0  -> (S(THINGY_SCALE*l,b,1.2*w),0) (C(l,w*.99,n-1,b-.028),0)',
			-- '(C(l,w,n,b),1) : n == 0 -> (S(.5*l,.5*TURN_OUTWARD,.9*l),0) (S(.5*l,.5*TURN_OUTWARD,.36*l),0) (S(.55*l,TURN_OUTWARD,.37*l),0) (S(.2*l,0,.46*l),0) (f(.15*l),0) (Gsc(.36*l),0)',
			
			'(C(l,w,n,b),1) : n == 0 -> (S(.5*l,.5*TURN_OUTWARD,.9*l),0) (S(.5*sqr(l),.5*TURN_OUTWARD,.75*l),0) (S(.55*l,TURN_OUTWARD,.6*l),0) (S(.55*sqr(l),TURN_OUTWARD,.6*l),0) (S(.8*l,0,.5*l),0) (S(.5*l,0,.46*l),0) (f(.25*l),0) (Gsc(.6*l),0)',
