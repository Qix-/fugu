...
function setup()
    ...
    axiom = '^(-pi/2) G#(1) (Gsc(.5),0) Gs G#(0) (A(.3,.2,STEM_SEGS,.1),0) Ge(4)'
    rules = {
				'(A(l,w,n,b),1) : n > 0  -> (S(l,b,w),0)(A(l,w*.9,n-1,b-.02),0)',
				'(A(l,w,n,b),1) : n == 0 -> (B(INTER_THING_LENGTH,.2,NUM_THINGS,.0),0)',
				...
				-- '(C(l,w,n,b),1) : n == 0 -> ',
				'(C(l,w,n,b),1) : n == 0 -> (S(1.*l,TURN_OUTWARD,.9*l),0) (S(1.*l,0.,.36*l),0) (S(.55*l,0.,.37*l),0) (S(.2*l,0.,.46*l),0) (f(.15*l),0) (Gsc(.36*l),0)',
