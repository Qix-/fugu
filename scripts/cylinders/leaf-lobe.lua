...
--	end
	--second seg
	obj.cs[1] = new_leaf_cs(1, 0.1, obj.f, 0.7*obj.b)

	obj.cs[2] = new_leaf_cs(1.1, 0.1, obj.f, 1*obj.b)
	obj.cs[3] = new_leaf_cs(1.1, 0.1, obj.f, 0.8*obj.b)

	--third seg
	obj.cs[4] = new_leaf_cs(0.9, 0.1, .9*obj.f, 0.4*obj.b)

	obj.cs[5] = new_leaf_cs(0.7, 0.1, .7*obj.f, 0.1*obj.b)
	obj.cs[6] = new_leaf_cs(0.3, 0.1, .3*obj.f, 0)

	obj.cs[7] = new_leaf_cs(0.1, 0.1, 0, 0)
